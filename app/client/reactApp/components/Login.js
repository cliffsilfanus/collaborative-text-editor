  ...
  renderErr = errMsg => {
    return (
      <div className="auth-content-wrap auth-err-wrap">
        <svg width="16px" height="16px" viewBox="0 0 24 24" fill="#d93025">
    ...
    return (
      <div className="auth-wrap">
        <div className="auth">
          ...
          <div className="auth-content-wrap">
            <div className="auth-subtitle">to continue to Horizons Docs</div>
          </div>
          <div className="auth-content-wrap">
            <input
              className={
          ...
          {this.state.wrongAuth && this.renderErr("Couldn't find your account")}
